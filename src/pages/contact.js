  ...
  <Container colors={data.site.siteMetadata.colors}>
    ...
    >
      <div style={{width: '70%', display: 'inline-block', float: 'left', paddingRight: rhythm(2) }}>
        ...
        <form name="contact" method="post" data-netlify="true" data-netlify-honeypot="bot-field"  action="/success/" >
          ...
          <div className="FormGroup">
            <input type="text" name="name" id="name" className="FormControl" required />
            <label className="FormControlPlaceholder" htmlFor="name">Your Name</label>
          </div>
          <div className="FormGroup">
            <input type="text" name="email" id="email" className="FormControl" required />
            <label className="FormControlPlaceholder" htmlFor="email">Your Email</label>
          </div>
          <div className="FormGroup">         
            <textarea name="message" id="message" className="FormControl" required />
            <label className="FormControlPlaceholder" htmlFor="message">Message</label>
          </div>
          <div>
      ...
      <div style={{width: '30%', display: 'inline-block', float: 'left'}}>
        ...
        <p>Email me: <a href="mailto:dave@unnatural.nl" style={{ color: data.site.siteMetadata.colors.darkGrey }}>dave@unnatural.nl</a></p>
        <p>Call me: <a href="tel:0031644106277" style={{ color: data.site.siteMetadata.colors.darkGrey }}>+31 6 44106277</a></p>
      </div>
    </Layout>
  </Container>
)
